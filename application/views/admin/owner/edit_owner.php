  ...
  <div class="col-xs-12">
    <div class="tabbable" id="tabs-491480">
      <ul class="nav nav-tabs">
        ...
        <li>
          <a href="/admin/owner/addTeamOwner">Add Team Owner</a>
        </li>
        <li class="active">
          <a>Edit Team Owner</a>
        </li>
        ...
        <div class="tab-pane active" id="panel-565086">
          <div class="col-xs-12">
            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
              <input type="hidden" value="<?php echo $owner_data['id']; ?>" name="owner_id">

              <div class="form-group required">
                <label class="control-label col-sm-2" for="">Owner Name:<span class="text-danger">*</span></label>
                <div class="col-sm-5">
                <input type="text"  required name="name" maxlength="50" value="<?php echo $owner_data['name']; ?>">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-5">
                  <select name="team_id" required>
                    ...
                    {
                      ?>
                      <option <?php if($owner_data['team_id']==$team_id){ echo 'selected'; }?> value="<?php echo $team_id; ?>"><?php echo $team_name; ?></option>
                    <?php
                    }
                    ?>
                  </select>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                <input type="text" name="company_name" maxlength="50" value="<?php echo $owner_data['company_name']; ?>">
