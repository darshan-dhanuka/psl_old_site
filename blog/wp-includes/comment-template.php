...
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields   =  array(
		'author' => '<div class="row"><div class="col-sm-4  col-xs-12"><p class="comment-form-author">' . '<label for="author">' . __( 'Name' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
		            '<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" maxlength="245"' . $aria_req . $html_req . ' /></p></div>',
		'email'  => '<div class="col-sm-4  col-xs-12"><p class="comment-form-email"><label for="email">' . __( 'Email' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
		            '<input id="email" name="email" ' . ( $html5 ? 'type="email"' : 'type="text"' ) . ' value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30" maxlength="100" aria-describedby="email-notes"' . $aria_req . $html_req  . ' /></p></div>',
		'url'    => '<div class="col-sm-4  col-xs-12"><p class="comment-form-url"><label for="url">' . __( 'Website' ) . '</label> ' .
		            '<input id="url" name="url" ' . ( $html5 ? 'type="url"' : 'type="text"' ) . ' value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" maxlength="200" /></p></div></div>',
	);
	...
	$defaults = array(
		'fields'               => $fields,
		'comment_field'        => '<div class="row"><div class="col-sm-12 col-xs-12"><p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'noun' ) . '</label> <textarea id="comment" name="comment" cols="45" rows="8" maxlength="65525" aria-required="true" required="required"></textarea></p></div></div>',
		...
		'logged_in_as'         => '<p class="logged-in-as">' . sprintf(
		                              ...
		                              __( '<span class="logged-user-photo">' . get_avatar( $current_user->ID, 32 ) . '</span><a href="%1$s" aria-label="%2$s" class="logged-user-name">%3$s</a> <span class="status">Right now</span> <!--<a href="%4$s">Log out?</a>-->' ),
		                              get_edit_user_link(),
		...
		'submit_field'         => '<div class="row"><div class="col-sm-12 col-xs-12"><p class="form-submit">%1$s %2$s</p></div>',
		'format'               => 'xhtml',
	);
